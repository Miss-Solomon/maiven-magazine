...
add_action( 'tgmpa_register', 'minerva_register_required_plugins' );
 ...
 */
function minerva_register_required_plugins() {
	/*
	 ...
	 */
	$config = array(
		'id'           => 'minerva',                 // Unique ID for hashing notices for multiple instances of TGMPA.
