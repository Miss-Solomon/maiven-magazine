...
function minerva_get_post_view() {
...
function minerva_set_post_view() {
...
if( !function_exists('minerva_post_tags')){
	
	function minerva_post_tags() {
...
// ----------------------------------------------------------------------------------------
function minerva_video_embed($url){
...
if(!function_exists('minerva_theme_post_navigation')) {
  function minerva_theme_post_navigation() { 
        ...
        <div class="theme_blog_Nav post_nav_Left <?php echo (empty($prev_thumbnail)) ? 'no-thumb':''; ?>">
          ...
          <div class="theme_blog_nav_Inner">
            <div class="theme_blog_nav_Label">
				...
				<?php $blog_prev_title = minerva_get_option('blog_prev_title');  ?>
      ...
      <div class="<?php echo esc_attr($col_class); ?>">
        ...
        <div class="theme_blog_Nav post_nav_Right <?php echo (empty($next_post_thumbnail)) ? 'no-thumb':''; ?>">
          ...
          <div class="theme_blog_Inner">
			...
			<?php $blog_next_title = minerva_get_option('blog_next_title');  ?>
...
function minerva_categories_postcount_filter ($variable) {
   $variable = str_replace('(', '<span class="post_count"> ', $variable);
   $variable = str_replace(')', ' </span>', $variable);
   return $variable;
}
add_filter('wp_list_categories','minerva_categories_postcount_filter');
